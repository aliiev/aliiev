...
import AboutImg from '../public/resources/images/about-min.jpg'
...
export default function About() {
	return (
	    ...
	    <div className="relative flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8 xl:gap-20 bg-neutral-800 rounded-lg md:rounded-xl w-full p-6 md:p-8 xl:p-12 overflow-hidden">
	      ...
	      <div className="relative rounded-lg md:rounded-xl w-full h-[50vh] md:w-1/2 overflow-hidden">
	        <Image layout="fill" objectFit="cover" src={ AboutImg } alt="Мое фото" />
	      </div>
