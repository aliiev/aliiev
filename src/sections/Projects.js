import RealmImg from '../resources/images/projects/realm-min.png'
import ArchmoveImg from '../resources/images/projects/archmove-min.png'
import OpenImg from '../resources/images/projects/open-min.png'
  ...
  <section id="projects" className="p-v">
    ...
    <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12 p-h">
      ...
      { projects.map((project, i) => (
        <div key={ i } className="card">
          <img className="border border-neutral-800 rounded-lg md:rounded-xl w:full sm:w-1/2 lg:w-full" src={ project.image } alt={ project.title } />
    ...
    <div className="text-center mt-6 lg:mt-12 p-h">
      <small className="text-xs text-neutral-400">
        Данные проекты не являются коммерческими. Дизайн был взят из публичных источников, после чего уже и был разработан мной.
      </small>
    </div>
  </section>
)
